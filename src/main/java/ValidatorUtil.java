...
public class ValidatorUtil {
    ...
    /** 身份证前2位。*/
    private static final String[] IDNO_CITY = new String[] { "11", "12", "13", "14", "15", "21", "22", "23", "31", "32",
     ...
     *        正在表达式。
     * @return
     *        true：匹配。<br/> false:不匹配。<br/> 如果str为null或trim后的长度为0，返回false.
     */
